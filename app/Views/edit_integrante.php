<?php 
    $id_investigadores = $datos[0]['id_investigadores'];
        ...
        <section class="signup">
            ...
            <div class="container">
                <div class="signup-content">
                    <form method="POST" id="editar" action="<?php echo base_url("integrantes-investigadores/update/")?>" method="POST" enctype="multipart/form-data" class="signup-form">
                        <h2 class="form-title">Editar Integrante</h2>
                        <input type="text" id="id_investigadores" name="id_investigadores" hidden="" 
                            value="<?php echo $id_investigadores ?>">
