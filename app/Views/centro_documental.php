...
<section id="hero-area" style="background-image: url('public/images/investigacion.jpg')">
    <div class="container">
        <div class="row">
            <div class="col-md-12 text-center">
                <div class="block wow fadeInUp" data-wow-delay=".3s">
                    ...
                    <h1 class="wow fadeInUp animated cd-headline slide" data-wow-delay=".4s">
                        ...
                        <div class="container subtitle wow fadeInUp animated text-center" data-wow-delay=".3s"
                            data-wow-duration="500ms"
                            style="margin-top: 100px; background: #fff; position:absolute; height: 150px;">
                            <h2>
                                El Sistema es conformado por mecanismos e instrumentos de recopilación,
                                sistematización, organización,
                                diagnóstico, intercambio, difusión, investigación, información, seguimiento y
