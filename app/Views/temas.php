...
<section   class="top-bar animated-header" style="z-index:1">
        <div class="container">
            <div class="row ">
                <div class="col-lg-12" >
    ...
    <section class="section" style="margin-top:30px">
        <div class="container">
            <div class="row">
                ...
                <div class="card col-md-4 wow animated  animate__bounceIn box1" data-wow-delay="0.2s"" style="margin: 25px">
                    <img class="card-img-top " src="<?php echo base_url('public/images_temas/'.$td['id_tema'].'/'.$td['imagen'])?>" style="height: 200px;"alt="Card image cap">
                    ...
                    <a href="<?= $td['link']?>" target="_blank" class="btn btn-primary" style="margin: 5px">Ver más</a>
                </div>
                <?php endforeach;?>
            </div>
