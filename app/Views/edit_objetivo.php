<?php 
    $id_objetivos = $datos[0]['id_objetivos'];
        ...
        <section class="signup">
            ...
            <div class="container">
                <div class="signup-content">
                    <form method="POST" id="editar" action="<?php echo base_url("objetivos-investigadores/update/")?>" method="POST" enctype="multipart/form-data" class="signup-form">
                        <h2 class="form-title">Editar Objetivo</h2>
                        <input type="text" id="id_objetivos" name="id_objetivos" hidden="" 
                            value="<?php echo $id_objetivos ?>">
