<?php 
    $id_comisiones = $datos[0]['id_comisiones'];
        ...
        <section class="signup">
            ...
            <div class="container">
                <div class="signup-content">
                    <form method="POST" id="editar" action="<?php echo base_url("comisiones-investigadores/update/")?>" method="POST" enctype="multipart/form-data" class="signup-form">
                        <h2 class="form-title">Editar Comisiones</h2>
                        <input type="text" id="id_comisiones" name="id_comisiones" hidden="" 
                            value="<?php echo $id_comisiones ?>">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" name="imagenComisiones"  id="imagenComisiones" type="file" value="<?php echo $imagen?>"/ style="color:#4469C5;" /><br />
                        </div>
                        <div class="form-group">
                        ...
                        <center><a class="txt1" href="<?php echo base_url('/red-investigadores-edit') ?>">
