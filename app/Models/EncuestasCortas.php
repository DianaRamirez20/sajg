<?php namespace App\Models;
    ...
    class EncuestasCortas extends Model{
        ...
        public function votosTotales(){
            ...
            $builder->select('(SELECT SUM(encuestascortasc.votos1+encuestascortasc.votos2+encuestascortasc.votos3+encuestascortasc.votos4) FROM encuestascortasc WHERE encuestascortasc.estatus="A") AS votos_totales', false);
            $query = $builder->get(); 
            return $query->getResultArray();
        }
